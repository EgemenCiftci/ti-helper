...
export class SettingsService {
  ...
  private defaultPreformedSentences = [
    ...
    "In the practical part, the candidate could not find most of the items and failed.",
    "In the theoretical part, the candidate answered some/most/all of the questions correctly.",
    "In the theoretical part, the candidate could not answer or partially answered most of the questions correctly.",
    ...
    "The candidate has good technical knowledge and likes to talk.",
    "I think the candidate has the ability to find a suitable solution when he doesn't know the exact answer.",
    "The candidate has a good understanding of [AREA] and is able to explain it well.",
